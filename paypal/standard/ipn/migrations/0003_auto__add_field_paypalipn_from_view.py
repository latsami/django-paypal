...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PayPalIPN.from_view'
        db.add_column('paypal_ipn', 'from_view', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PayPalIPN.from_view'
        db.delete_column('paypal_ipn', 'from_view')
